...
typedef struct _I2cMessage
{
  ...
  k_msgq           clientQueue;       //< Queue to send received messages to.
...
extern const struct device deckBus;
extern const struct device sensorsBus;

/**
 * Initialize i2c peripheral as defined by static I2cDef structs.
 */
void i2cdrvInit(const struct device* i2c);
 ...
 */
bool i2cdrvMessageTransfer(const struct device* i2c, I2cMessage* message);
